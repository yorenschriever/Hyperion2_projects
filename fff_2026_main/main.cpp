...
int main()
{
    ...
    hyp.hub.setColumnName(Columns::MASKS, "Masks");
...
void addDomeChain()
{
    ...
    auto input = new ControlHubInput<RGBA>(
        ...
        &hyp.hub,
        {
            ...
            {.column = Columns::DOME_PULSE, .slot = 3, .pattern = new AerialPatterns::DoubleFlash()},
            {.column = Columns::DOME_PULSE, .slot = 4, .pattern = new LedPatterns::StrobePattern()},
            {.column = Columns::DOME_PULSE, .slot = 5, .pattern = new LedPatterns::StrobeHighlightPattern()},
            {.column = Columns::DOME_PULSE, .slot = 6, .pattern = new LedPatterns::PixelGlitchPattern()},
            {.column = Columns::DOME_PULSE, .slot = 7, .pattern = new LedPatterns::SegmentGlitchPattern()},
            {.column = Columns::DOME_PULSE, .slot = 8, .pattern = new TriggerPatterns::FadingNoisePattern()},
            {.column = Columns::DOME_PULSE, .slot = 9, .pattern = new TriggerPatterns::SlowPulsePattern()},
...
void addStageChain()
{
    ...
    auto input = new ControlHubInput<RGBA>(
        ...
        &hyp.hub,
        {
            ...
            {.column = Columns::STAGE_PULSE, .slot = 1, .pattern = new LedPatterns::SegmentGlitchPattern()},
            {.column = Columns::STAGE_PULSE, .slot = 2, .pattern = new TriggerPatterns::SlowPulsePattern()},
            {.column = Columns::STAGE_PULSE, .slot = 3, .pattern = new TriggerPatterns::FadingNoisePattern()},
            {.column = Columns::STAGE_PULSE, .slot = 4, .pattern = new TriggerPatterns::PulsePattern()},
...
void addObeliskChain()
{
    ...
    auto input = new ControlHubInput<RGBA>(
        ...
        &hyp.hub,
        {
            ...
            {.column = Columns::OBELISK_PULSE, .slot = 0, .pattern = new LedPatterns::FlashesPattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 1, .pattern = new LedPatterns::StrobePattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 2, .pattern = new LedPatterns::StrobeHighlightPattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 3, .pattern = new LedPatterns::PixelGlitchPattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 4, .pattern = new LedPatterns::SegmentGlitchPattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 5, .pattern = new LedPatterns::SegmentGlitchPattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 6, .pattern = new TriggerPatterns::PulsePattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 7, .pattern = new LedPatterns::BeatShakePattern(2 * 60)},
            {.column = Columns::OBELISK_PULSE, .slot = 8, .pattern = new TriggerPatterns::FadingNoisePattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 9, .pattern = new TriggerPatterns::SlowPulsePattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 10, .pattern = new TriggerPatterns::FadingNoisePattern()},
            {.column = Columns::OBELISK_PULSE, .slot = 11, .pattern = new TriggerPatterns::FadeFromRandom(2 * 60)},
            {.column = Columns::OBELISK_PULSE, .slot = 12, .pattern = new TriggerPatterns::Meteor(15, 50, 600, "Meteor base up"), .indexMap = reverseMap},
            {.column = Columns::OBELISK_PULSE, .slot = 13, .pattern = new TriggerPatterns::Meteor(15, 50, 600, "Meteor base down"),},
            {.column = Columns::OBELISK_PULSE, .slot = 14, .pattern = new TriggerPatterns::LineLaunch(map2d, 100, 20)},
            {.column = Columns::OBELISK_PULSE, .slot = 15, .pattern = new TriggerPatterns::LineLaunch(map2d, 500, 20)},
            {.column = Columns::OBELISK_PULSE, .slot = 16, .pattern = new TriggerPatterns::LineLaunch(map2d, 1000, 20)},

            {.column = Columns::MASKS, .slot = i++, .pattern = new MaskPatterns::SegmentGlitchMaskPattern()},
...
void addAerialChain()
{
    ...
    auto input = new ControlHubInput<RGBA>(
        ...
        &hyp.hub,
        {
            ...
            {.column = Columns::AERIAL, .slot = 6, .pattern = new AerialPatterns::GradientChasePattern()},
            {.column = Columns::AERIAL, .slot = 7, .pattern = new AerialPatterns::GradientChasePattern(), .indexMap = zigzag},
            {.column = Columns::AERIAL, .slot = 8, .pattern = new AerialPatterns::SinChasePattern()},
            {.column = Columns::AERIAL, .slot = 9, .pattern = new AerialPatterns::SinChasePattern(), .indexMap = zigzag},
            ...
            {.column = Columns::MASKS, .slot = 0, .pattern = new MaskPatterns::SegmentGlitchMaskPattern()},
